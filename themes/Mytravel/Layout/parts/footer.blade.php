...
<script src="{{ asset('themes/ipohgo/libs/jquery-migrate/jquery-migrate.min.js') }}"></script>
<script src="{{ asset('themes/ipohgo/libs/header.js') }}"></script>
<script>
...
<script src="{{ asset('themes/ipohgo/libs/fancybox/jquery.fancybox.min.js') }}"></script>
<script src="{{ asset('themes/ipohgo/libs/slick/slick.js') }}"></script>
...
<script src="{{ asset('themes/ipohgo/js/functions.js?_ver='.config('app.asset_version')) }}"></script>
<script src="{{asset('themes/ipohgo/libs/custombox/custombox.min.js')}}"></script>
<script src="{{asset('themes/ipohgo/libs/custombox/custombox.legacy.min.js')}}"></script>
<script src="{{ asset('themes/ipohgo/libs/custombox/window.modal.js') }}"></script>
...
<script src="{{ asset('themes/ipohgo/js/home.js?_ver='.config('app.asset_version')) }}"></script>
...
@endif
@if(request('preview'))
    <script src="{{ asset('themes/ipohgo/module/template/preview.js?_ver='.config('app.asset_version')) }}"></script>
@endif
