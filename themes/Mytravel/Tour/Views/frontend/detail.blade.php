@extends('layouts.app')
@push('css')
    <link href="{{ asset('/themes/ipohgo/dist/frontend/module/tour/css/tour.css?_ver='.config('app.asset_version')) }}" rel="stylesheet">
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('/themes/ipohgo/module/tour/js/single-tour.js?_ver='.config('app.asset_version')) }}"></script>
@endpush
