@extends('layouts.app')
@push('css')
    <link href="{{ asset('/themes/ipohgo/dist/frontend/module/car/css/car.css?_ver='.config('app.asset_version')) }}" rel="stylesheet">
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('/themes/ipohgo/module/car/js/single-car.js?_ver='.config('app.asset_version')) }}"></script>
@endpush
