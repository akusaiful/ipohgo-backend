...
class Tour extends Seeder
{
    ...
    public function run()
    {
        ...
        $categories =  [
            ['name' => 'Accomodation', 'content' => '', 'status' => 'publish',],
            ['name' => 'Hotel', 'content' => '', 'status' => 'publish', 'parent_id' => 1],
            ['name' => 'Homestay', 'content' => '', 'status' => 'publish', 'parent_id' => 1],
            ['name' => 'Resort', 'content' => '', 'status' => 'publish', 'parent_id' => 1],
            
            ['name' => 'Food', 'content' => '', 'status' => 'publish',],
            ['name' => 'Business', 'content' => '', 'status' => 'publish',],
            ['name' => 'Recreation & Natural', 'content' => '', 'status' => 'publish',],
            ['name' => 'Heritage Trail', 'content' => '', 'status' => 'publish',],
            ['name' => 'Medicine', 'content' => '', 'status' => 'publish',]
        ];
