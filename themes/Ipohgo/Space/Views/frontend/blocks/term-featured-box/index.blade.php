                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="rounded-xs mb-5">
                            <a class="d-block" href="{{ $page_search }}">
                                <div class="bg-img-hero gradient-overlay-half-bg-white transition-3d-hover shadow-hover-2 max-height-200" style="background-image: url({{asset('themes/ipohgo/images/space-background.jpg')}});">
