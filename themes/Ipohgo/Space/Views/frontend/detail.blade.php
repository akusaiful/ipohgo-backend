@extends('layouts.app')
@push('css')
    <link href="{{ asset('themes/ipohgo/dist/frontend/module/space/css/space.css?_ver='.config('app.asset_version')) }}" rel="stylesheet">
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('themes/ipohgo/module/space/js/single-space.js?_ver='.config('app.asset_version')) }}"></script>
@endpush
