...
<a href="mailto:akusaiful@gmail.com">akusaiful@gmail.com</a>',
                    'group' => "general",
                ],
                [
                    'name'  => 'footer_text_left',
                    'val'   => 'Copyright © 2023 by POI Ipoh',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>POI Ipoh</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        $settings = [
                ...
                [
                    'name'  => 'map_gmap_key',
                    'val'   => 'AIzaSyCP7X8R-7iQKWGvM0Bazfjn3kFhBfjX6Cw',
                    'group' => "advance",
                ],
                [
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">POI Ipoh</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2023 POI Ipoh. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with POI Ipoh! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>POI Ipoh</p>',
                    'group' => "user",
                ],
            ...
            [
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>POI Ipoh Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
