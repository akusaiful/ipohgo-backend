...
class HomeController extends Controller
{
    ...
    {
        // return 'hello';
        $setting = Settings::whereName('privacy')->first();        
        return view('Page::frontend.privacy', ['setting' => $setting]);
    
    }

    public function delete()
    {                
        return view('Page::frontend.delete');    
    }
    ...
    public function deleteAction(Request $request){
        ...
        // if($user){
        return view('Page::frontend.delete-action', ['email' => $request->email]);
        // }
