<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group-item">
                ...
                @if(!empty($translation->faqs))
                    ...
                    @foreach($translation->faqs as $key=>$faq)
                        <div class="item" data-number="{{$key}}">
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text" name="faqs[{{$key}}][title]" class="form-control" value="{{$faq['title']}}" placeholder="{{__('Eg: How to reach here? Is there any entrance fee?')}}">
                                </div>
                                <div class="col-md-6">
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="faqs[__number__][title]" class="form-control" placeholder="{{__('Eg: How to reach here? Is there any entrance fee?')}}">
                        </div>
                        <div class="col-md-6">
        ...
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Banner Image (Normal Image Card)")}}</label>
