...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard' }} - {{ setting_item('site_title') ?? 'POI Ipoh' }}</title>
...
<body
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            {{ date('Y') }} &copy; {{ __('IpohGO by') }} <a
                                href="{{ __('https://www.mbi.gov.my/') }}"
                                target="_blank">{{ __('Nexis Solution') }}</a>
                        </div>
                        <div class="col-md-6">
    ...
    <script
        src="{{ asset('themes/admin/libs/bootstrap-4.6.2-dist/js/bootstrap.bundle.min.js?_ver=' . config('app.asset_version')) }}">
    </script>
