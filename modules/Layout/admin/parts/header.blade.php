...
<div class="header-logo flex-shrink-0 pl-5 pt-1">
    <a href="{{route('admin.index')}}"><img src="{{ asset('images/logo_ipohgo_white.png') }}" alt="" style="width: 150px"></a>
    <!--
    <h3 class="logo-text"><a href="{{route('admin.index')}}">{{$theme::$name}}</a></h3>
    -->
</div>
<div class="header-widgets d-flex flex-grow-1">
    <div class="widgets-left d-flex flex-grow-1 align-items-center">
        ...
        <div class="header-widget search-widget">
            ...
            <a href="{{url('/')}}" class="btn btn-link" target="_blank"><i class="fa fa-home"></i> {{__('Home')}}
            </a>
        </div>
    </div>
