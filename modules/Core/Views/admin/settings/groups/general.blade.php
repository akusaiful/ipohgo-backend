<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Information of your mobile app')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Privacy Policy")}}</h3>
        <p class="form-group-desc">{{__('Privacy policy for your mobile app user')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <textarea name="privacy" class="d-none has-ckeditor" cols="30" rows="10">{{setting_item_with_lang('privacy',request()->query('privacy')) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
